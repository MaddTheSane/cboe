...
public:
	...
	public:
		...
		short property;
		cItemStorage();
		cItemStorage& operator = (const legacy::item_storage_shortcut_type& old);
	};
...
public:
	...
	void import_legacy(const legacy::scenario_data_type& old);
	void import_legacy(const legacy::scen_item_data_type& old);
