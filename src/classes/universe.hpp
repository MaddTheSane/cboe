...
public:
	...
	void import_legacy(const legacy::current_town_type& old);
	void import_legacy(const legacy::town_item_list& old);
	void import_legacy(const unsigned char(& old_sfx)[64][64], const unsigned char(& old_misc_i)[64][64]);
...
public:
	...
	void import_legacy(const legacy::out_info_type& old);
...
public:
	...
	void import_legacy(const legacy::stored_town_maps_type& old);
	void import_legacy(const legacy::stored_outdoor_maps_type& old);
